...
@section('content')
    @component('inner.components.bread-crumb-component', ['title' => $student->name, 'nameIcon' => 'pe-7s-bookmarks'])
        @slot('action')
                ...
                <div class="card-body">
                    ...
                    <form class="row" action="{{ route('students.update', $student->id) }}" method="POST">
                        ...
                        <div class="position-relative form-group col-4">
                            ...
                            <input name="name" id="name" placeholder="Nome do Aluno" type="text" value="{{$student->name}}"
                                   class="form-control">
                        </div>
                        <div class="position-relative form-group col-4">
                            <label for="cpf" class="">CPF</label>
                            <input name="cpf" id="cpf" placeholder="CPF do Aluno" type="text" value="{{$student->cpf}}"
                        ...
                        <div class="position-relative form-group col-4">
                            ...
                            <input name="date_birth" id="date_birth" placeholder="Data de nascimento do Aluno" type="text"
                                   class="form-control" value="{{$student->date_birth}}" v-mask="'##/##/####'">
                        </div>
                        <div class="position-relative form-group col-5">
                            <label for="email" class="">Email</label>
                            <input name="email" id="email" placeholder="Email do Aluno" type="text" value="{{$student->email}}"
                                   class="form-control">
                        </div>
                        <div class="position-relative form-group col-3">
                            <label for="phone" class="">Telefone</label>
                            <input name="phone" id="phone" placeholder="Telefone do Aluno" type="text" value="{{$student->phone}}"
                                   class="form-control" v-mask="['(##) ####-####', '(##) #####-####']">
                        </div>
                        <div class="col-12 divider"></div>
                        <div class="position-relative form-group col-4">
                            <label for="street" class="">Rua</label>
                            <input name="street" id="street" placeholder="Rua" type="text" value="{{$student->street}}"
                                   class="form-control">
                        </div>
                        <div class="position-relative form-group col-2">
                            <label for="number" class="">Número</label>
                            <input name="number" id="number" placeholder="Número" type="text" value="{{$student->number}}"
                                   class="form-control">
                        </div>
                        <div class="position-relative form-group col-3">
                            <label for="district" class="">Bairro</label>
                            <input name="district" id="district" placeholder="Bairro" type="text" value="{{$student->district}}"
                                   class="form-control">
                        </div>
                        <div class="position-relative form-group col-3">
                            <label for="city" class="">Cidade</label>
                            <input name="city" id="city" placeholder="Cidade" type="text" value="{{$student->city}}"
                                   class="form-control">
                        </div>
                        <div class="position-relative form-group col-2">
                            <label for="uf" class="">UF</label>
                            <select name="uf" id="uf" class="form-control" v-model="form.uf">
                        ...
                        <div class="position-relative form-group col-3">
                            ...
                            <select name="course_id" id="course_id" class="form-control" v-model="form.course_id">
...
@section('scripts')
    @parent
    <script>
        const form_course_id = '{{$student->course_id}}';
        const form_uf = '{{$student->uf}}';
        const form_status = '{{$student->status}}';
    </script>
    <script type="text/javascript" src="/js/student.edit.js"></script>
@endsection
